...
Config.Elevators = {
    ...
    --Added vector3 according to qb-fbi, you can change it according to you aslo.
    --qb-fbi : https://github.com/Daltrix-Gaming/qb-fbi
    ["restricted"] = {
        Group = {"police", "ambulance", "lostmc","fbi" },                                -- Leave blank if you don't want to use Player Job - You can add jobs or gangs groups
        ...
        Floors = {
            [1] = {
                ...
                Restricted = true,
                Coords = vector3(136.98, -761.82, 242.15),
                ExitHeading = "297.06"
            },
            -- [2] = {
            --     Label = "Floor 2",
            ...
            [2] = {
                ...
                Restricted = false,
                Coords = vector3(139.54, -763.77, 45.75),
                ExitHeading = "28.74"
            },
        }
    },
